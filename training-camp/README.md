...
- `2020-08-13` part3-1: 手写 Vue Router、手写响应式实现、虚拟 DOM 和 Diff 算法（下）
- `2020-08-20` part3-2：大厂面试真题解析
- `2020-08-26` part3-2：AST 语法树、自动化部署、互动答疑
- `2020-09-07` - `2020-09-14` 第一次模拟考试（ part1-1 到 part3-1）
- `2020-09-08` part3-2：CAZ 脚手架源码讲解
...
- part3-3：[NuxtJS 综合案例](./notes/part3-3/NuxtJSCase.md) ([案例演示地址](https://conduit.jencia.vercel.app))、[作业](./tasks/part3-3/README.md)